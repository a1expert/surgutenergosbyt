uAdmin('.ieditor', function (extend) {
	...
	var settings = {
		...
		image_data_url: '/udata/content/getImageData.json',
		...
		browser_modules: {
			msie: [FilemanagerModule, EditModule, RotateModule, PopupModule, ApplyModule, CancelModule, DeleteModule],
			mozilla: [FilemanagerModule, UploadModule, EditModule, RotateModule, ResizeModule, CropModule, PopupModule, ApplyModule, CancelModule, DeleteModule],
			opera: [FilemanagerModule, UploadModule, EditModule, RotateModule, ResizeModule, CropModule, PopupModule, ApplyModule, CancelModule, DeleteModule],
			webkit: [FilemanagerModule, UploadModule, EditModule, RotateModule, ResizeModule, CropModule, PopupModule, ApplyModule, CancelModule, DeleteModule]
		}
	...
	uImageEditor.prototype.getNodes = uImageEditor.getNodes = function (bReturnJquery) {
		jqNodes = jQuery("img[umi\\:field-name], .mceEditor img, [umi\\:field-type='wysiwyg'] img");
	...
	ImageEditorBase.prototype.applyImageSizes = function (jqImageNode) {
		...
		var size = {width: jqImageNode.width(), height: jqImageNode.height()};
		jqImageNode.css(size).attr(size);
