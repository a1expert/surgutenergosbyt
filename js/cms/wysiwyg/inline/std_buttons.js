inlineWYSIWYG.createSimple('Bold',					{'button-label': 'Bold', 'button-title': 'Жирный', 'prefix': 'b'});
inlineWYSIWYG.createSimple('Italic',				{'button-label': 'Italic', 'button-title': 'Курсив', 'prefix': 'i'});
inlineWYSIWYG.createSimple('Underline',				{'button-label': 'Underlined', 'button-title': 'Подчеркнутый', 'prefix': 'u'});

inlineWYSIWYG.createSimple('JustifyLeft',			{'button-label': 'Left', 'button-title': 'Выравнивание по левому краю', 'prefix': 'l'});
inlineWYSIWYG.createSimple('JustifyCenter',			{'button-label': 'Center', 'button-title': 'Выравнивание по центру', 'prefix': 'c'});
inlineWYSIWYG.createSimple('JustifyRight',			{'button-label': 'Right', 'button-title': 'Выравнивание по правому краю', 'prefix': 'r'});

inlineWYSIWYG.createSimple('InsertOrderedList',		{'button-label': 'InsertOrderedList', 'button-title': 'Нумерованный список', 'prefix': 'ol'});
inlineWYSIWYG.createSimple('InsertUnorderedList',	{'button-label': 'InsertUnorderedList', 'button-title': 'Маркированный список', 'prefix': 'ul'});
...
inlineWYSIWYG.button('InsertImage', {
	...
	execute: function (params, targetNode, sels) {
		...
		if((jQuery.browser.msie ? node.tagName.toLowerCase() == 'img' : node instanceof HTMLImageElement)) {
		...
		var _sels = sels;
		if (jQuery.browser.msie && (!sels.isSomethingSelected() && !css.length)) {
...
inlineWYSIWYG.button('StylesFormatting', {
	init: function (params) {
		...
		var i;
		for(i in inlineWYSIWYG.stylesFormats) {
			var option = document.createElement('option');
			option.value = i;
			option.innerHTML = inlineWYSIWYG.stylesFormats[i];
	...
	status: function (params, targetNode, sels) {
		...
		if(inlineWYSIWYG.stylesFormats[tagName]) {
