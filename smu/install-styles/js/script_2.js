...
jQuery(document).ready(function(){
	jQuery.ajaxSetup({
		error: function() {
			...
			jQuery(".img_stop img").attr("src", "http://umi-cms.ru/install/icon_stop_red.png");
...
function checkRestore(r) {
	...
	if (error.length>0) {		
		...
		jQuery(".step20 .img_stop img").attr("src", "http://umi-cms.ru/install/icon_stop_red.png");
...
function checkResponse(r) {
	...
	if(response.attr('type') == 'ok') {
		...
		jQuery("div.img_stop img").attr('src', 'http://umi-cms.ru/install/icon_stop_red.png');
...
function showStep() {
	...
	if (step!=0) {
		...
		jQuery("div.img_stop img").attr("src", "http://umi-cms.ru/install/ikon_stop.png");
