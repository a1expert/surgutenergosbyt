		...
		if(function_exists("mysql_connect")) {
			...
			if($r === false) {
				...
				if($r === false) {
					...
					// try set default charset
					@mysql_query("ALTER DATABASE " . $dbname . " CHARACTER SET = utf8");
				}
			}
		} else {
...
XML;
	...
	function doInstallSite() {
		...
		$installer = new packageInstaller("./sites/{$sitename}", dirname(__FILE__));
