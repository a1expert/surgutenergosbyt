	...
	*/
	...
	class phpGSB {
		...
		function getData($body)
		{
			...
			$result = $this->googleDownloader("http://sba.yandex.net/downloads?client=api&apikey=".$this->apikey."&appver=".$this->version."&pver=".$this->apiversion,$buildopts,"data");
		...
		function doFullLookup($prefixes,$originals)
		{
			...
			$buildopts = array(CURLOPT_POST=>true,CURLOPT_POSTFIELDS=>$body);
			$result = $this->googleDownloader("http://sba.yandex.net/gethash?client=api&apikey=".$this->apikey."&appver=".$this->version."&pver=".$this->apiversion,$buildopts,"lookup");
