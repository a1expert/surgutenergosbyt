 ...
 */
	class baseModuleAdmin {
		 ...
		 * @param unknown_type $byValue
		 * @param unknown_type $ignoreDeleted
		 ...
		 * TODO PHPDoc
		 * Enter description here ...
		 * @param unknown_type $redirect_string
		 */
		 ...
		 * Enter description here ...
		 * @param unknown_type $inputData
		 * @param unknown_type $ignoreIfNull
		 * @throws coreException
		 */
		 ...
		 * @param unknown_type $requiredPermission
		 ...
		 * @param unknown_type $baseGuideId
		 */
