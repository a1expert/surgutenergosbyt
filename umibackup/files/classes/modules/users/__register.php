<?php
	abstract class __register_users {
		...
		public function registrate_do($template = "default") {
			...
			$mailContent = def_module::parseTemplateForMail($template_mail, $mailData, false, $object_id);
			$mailSubject = def_module::parseTemplateForMail($template_mail_subject, $mailData, false, $object_id);
