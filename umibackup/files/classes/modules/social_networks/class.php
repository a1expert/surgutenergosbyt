...
';
	...
	public function  getSettings() {
		...
		$result['vkontakte'] = Array(
			...
			"attribute:wishlist_enabled"	=>  $widgets && (int) $regedit->getVal('//modules/emarket/social_vkontakte_wishlist'),
			"attribute:order_enabled"		=>  $widgets && (int) $regedit->getVal('//modules/emarket/social_vkontakte_order'),
