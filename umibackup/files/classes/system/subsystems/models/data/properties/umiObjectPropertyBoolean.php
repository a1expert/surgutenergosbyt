<?php
	...
	class umiObjectPropertyBoolean extends umiObjectProperty {
		/**
		 * Загружает значение свойства из БД, если тип свойства "Кнопка-флажок"
		 * @return Array массив со значением Boolean
		 */
		...
		/**
		 * Сохраняет значение свойства в БД, если тип свойства "Кнопка-флажок"
		 */
