...
//			return $this->setObjectIsUpdated();
		...
		public static function filterOutputString($string) {
			if (isset($_SERVER['DOCUMENT_ROOT']) && cmsController::getInstance()->getCurrentMode() != "admin" && !umiObjectProperty::$IGNORE_FILTER_OUTPUT_STRING && !(defined("CRON") && CRON)) {
				$string = str_replace(array("&#037;", "&#37;"), "%", $string);
			}
			return $string;
		}
		...
		/**
		 * TODO PHPDoc
		 * TODO ммм классная функция... deprecated?
		 * Enter description here ...
