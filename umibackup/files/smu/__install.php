...
function check_writeable() {
	...
	$file = get_file('http://www.umi-cms.ru/install/writable_directories.txt');
	$dirs = explode("\n", $file);	
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="http://umi-cms.ru/install/js/script_2.js" type="text/javascript"></script>
		<script src="http://umi-cms.ru/install/a.php" type="text/javascript"></script>
	...
	<body>
		<form id="form1" action="">
			<div class="header">
				...
				<a href="http://umi-cms.ru" title="UMI.CMS" target="_blank"><img alt="" src="http://umi-cms.ru/install/logo_.png" class="logo" /></a>
			</div>
			<div class="main">
				<div class="display_none shadow_some step0">
					<div class="padding_big">
						...
						<div class="info">
							<div class="img_stop">
								<img alt="" src="http://umi-cms.ru/install/ikon_stop.png"  />
							</div>
				...
				<div class="display_none shadow_some step3 step4 step5 step7">
					<div class="padding_big">
						<div class="loading">
							...
							<div class="clear"></div>
							<div class="b_input">
								<img alt="" src="http://umi-cms.ru/install/progress_bar_img.gif" class="progressbar_img" />
							</div>
				...
				<div class="display_none last_block text_align2 shadow_some step9">
					<div class="padding_big">
						<img alt="" src="http://umi-cms.ru/install/galochka_big.png" />
				...
				<div class="display_none last_block text_align2 shadow_some step10">
					<div class="padding_big">
						...
						?>
						<p class="the_end_p"><b>Внимание! Оба этих способа (и переустановка и восстановление)<br />приведут к уничтожению всех имеющихся сейчас<br /> данных вашего сайта. <br />Это действие нельзя будет отменить.</b></p>
						<div class="clear"></div>
					</div>
				</div>
