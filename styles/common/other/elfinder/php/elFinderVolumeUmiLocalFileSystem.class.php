	...
	class elFinderVolumeUmiLocalFileSystem extends elFinderVolumeLocalFileSystem {
		...
		*/
		public function rename($hash, $name) {
			...
			if ($newExt != $ext) return $this->setError(elFinder::ERROR_INVALID_NAME, $name); 
		...
		* 
		* @param mixed $old_locale список зачение, полученных c LC_ALL
		*/
		...
		*/
		protected function _checkArchivers() {
			return $this->options['archivers'] = $this->options['archive'] = array();
		}
		...
		*/
		...
		protected function procExec($command , array &$output = null, &$return_var = -1, array &$error_output = null) {
			...
			$process = proc_open($command, $descriptorspec, $pipes, null, null) or false;
