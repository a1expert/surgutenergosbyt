...
*/
	class umiImageFile extends umiFile implements iUmiImageFile {
		...
		public function __construct($filepath) {
			...
			if (!$this->getIsBroken()) {
				...
				switch ($arImageInfo['mime']) {
					case 'image/gif': $this->sImageType = self::IMAGE_TYPE_GIF; break;
					case 'image/jpg': $this->sImageType = self::IMAGE_TYPE_JPG; break;
					case 'image/jpeg': $this->sImageType = self::IMAGE_TYPE_JPEG; break;
					case 'image/png': $this->sImageType = self::IMAGE_TYPE_PNG; break;
					case 'image/vnd.wap.wbmp': $this->sImageType = self::IMAGE_TYPE_WBMP; break;
					case 'image/bmp': $this->sImageType = self::IMAGE_TYPE_BMP; break;
					case 'application/x-shockwave-flash': $this->sImageType = self::IMAGE_TYPE_SWF; break;
				}
			}
		}
		...
		*/
		 ...
		 * @param $newImage ссылка на ресурс изображения (GD)
		 */
