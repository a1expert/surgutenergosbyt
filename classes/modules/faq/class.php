...
class faq extends def_module {
	...
	public function project($template = "default", $element_path = false, $limit = false, $ignore_paging = false) {
		...
		$categories->types('hierarchy-type')->name('faq', 'category');
		$categories->where('hierarchy')->page($project_id)->childs(1);
	...
	public function category($template = "default", $element_path = false, $limit = false, $ignore_paging = false, $order = true) {
		...
		$questions->types('hierarchy-type')->name('faq', 'question');
		$questions->where('hierarchy')->page($category_id)->childs(1);
	...
	public function projects($template = "default", $limit = false, $ignore_paging = false) {
		...
		$projects->types('hierarchy-type')->name('faq', 'project');
	...
	public function post_question() {
		...
		$object_type_id = $this->umiObjectTypesCollection->getBaseType("faq", "question");
