...
HTML;
		...
		if($isAllowed) {
			...
			$pageData = json_encode(array(
				...
				<script type="text/javascript" charset="utf-8" src="/js/jquery/fancybox/jquery.fancybox.js?{$build}"></script>
				<script type="text/javascript" charset="utf-8" src="/js/cms/init_fancybox.js?{$build}"></script>
